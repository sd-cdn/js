document.addEventListener("DOMContentLoaded", function () {
    // 1. CSS को Head में डालना (सिर्फ एक बार पूरी वेबसाइट के लिए)
    ...
    style.innerHTML = `
        ...
        /* मोबाइल के लिए छोटे बटन (Optional) */
        @media (max-width: 480px) {
            .img-btn { padding: 5px 10px; font-size: 12px; }
        }
    `;
    ...
    // 3. सभी .social-join क्लास वाले एलीमेंट को ढूंढें और कंटेंट डालें
    ...
    allSocialBoxes.forEach(container => {
        container.innerHTML = `
            ...
            <a href="https://whatsapp.com/channel/0029VaB5GSX96H4JVQ8nKr2O" class="img-btn wa-btn" target="_blank" rel="noopener">
                ${icons.wa} WhatsApp
            </a>
            <a href="https://t.me/SarkariJob24_com" class="img-btn tg-btn" target="_blank" rel="noopener">
                ${icons.tg} Telegram
            </a>
            <a href="https://www.facebook.com/SarkariJob24.ComOfficial" class="img-btn fb-btn" target="_blank" rel="noopener">
                ${icons.fb} Facebook
            </a>
            <a href="https://www.instagram.com/sarkarijob24_official/" class="img-btn ig-btn" target="_blank" rel="noopener">
                ${icons.ig} Instagram
            </a>
        `;
    });
