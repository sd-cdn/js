/* Universal Social Join Code for All Websites */
document.addEventListener("DOMContentLoaded", function () {
    // 1. CSS को Head में डालना
    ...
    style.innerHTML = `
        ...
        .img-btn:hover { transform: translateY(-2px); filter: brightness(1.1); box-shadow: 0 4px 8px rgba(0,0,0,0.1); }
    `;
    ...
    // 3. Inject Content
    const boxes = document.querySelectorAll(".social-join");
    boxes.forEach(box => {
        box.innerHTML = `
